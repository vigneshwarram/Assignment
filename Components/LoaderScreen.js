...
const LoaderScreen = () => {
    ...
    const numberOfPosts = new Array(3).fill(null);
      const PostLayout = () => (
        <SkeletonLoader duration={1000} boneColor ={'#ffffff'} highlightColor={'#f0f0f0'} style={{ marginVertical: 10 }}>
          <AvatarLayout style={{ marginBottom: 10 }} />
      
          <SkeletonLoader.Item
            style={{ width:350, height: 150 ,marginVertical: 10 ,marginHorizontal:30}}
          />
        </SkeletonLoader>
      );
  return (
